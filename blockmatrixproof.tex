...
\tilde{a}_0^+ - \tilde{a}_1^- & \tilde{a}_1^- &&& -\tilde{a}_0^+ \\
-\tilde{a}_1^+ & \tilde{a}_1^+ - \tilde{a}_2^- & \tilde{a}_2^- \\
& -\tilde{a}_2^+ & \tilde{a}_2^+ - \tilde{a}_3^- & \tilde{a}_3^- \\ && \ddots \\
\\
\tilde{a}_0^- &&& -\tilde{a}_{n-1}^+ & \tilde{a}_{n-1}^+ - \tilde{a}_0^- 
\end{pmatrix}
\end{align*}
with entries
\begin{align*}
...
\item For the terms involving $D$, we place the leading order terms from the center jump expression into a matrix $\lambda \tilde{A}$, where
\begin{align*}
\tilde{A} &= \begin{pmatrix}
\tilde{a}_0^+ - \tilde{a}_1^- & \tilde{a}_1^- &&& -\tilde{a}_0^+ \\
-\tilde{a}_1^+ & \tilde{a}_1^+ - \tilde{a}_2^- & \tilde{a}_2^- \\
