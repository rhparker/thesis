...
Finally, we evaluate $\langle W_0, L_3(\lambda)_i(a,b,c,d)$. First, we look at the term involving $a_i^c$. Using \cref{Pnulambda1} from \cref{nulambdalemma},
\begin{align*}
P^c(\lambda) V_0 &= \left( \langle W_0(\lambda), V_0 \rangle + \mathcal{O}(|\lambda|^2) \right)  V_0(\lambda) \\
&= \langle W_0 + \overline{\lambda}W_0'(0) + \mathcal{O}(|\lambda|^2), V_0 \rangle (V_0 + \lambda V'(0) + \mathcal{O}(|\lambda|^2)) \\
&= V_0 + \lambda V'(0) + \mathcal{O}(|\lambda|^2)).
\end{align*}
Using \cref{W0projlemma}(iii) and \cref{PclambdaV0} with the $a_i^c$ term, we have
\begin{align*}
