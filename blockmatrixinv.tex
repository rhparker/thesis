...
|A_1(\lambda)(b, c, d)| \leq C \left( e^{-\tilde{\alpha} X^*} |b| + |\lambda|^2 |d| + (e^{-\alpha X_*} + |C_i|)|c| + |D_i||d| \right)
\end{align} 
...
|\tilde{A}_2(\lambda)(b, c, d) &\leq C |\lambda| e^{-\alpha X^*} \left( e^{-\tilde{\alpha} X^*}  |b| + |c| +|\lambda|^2 |d| \right) \label{tildeA2bound}
\end{align}
...
&= c_i \left( R \Theta_+(X_i; 0) R - \Theta_+(X_i; 0) \right) V_0 + \mathcal{O}(|\lambda|e^{-\alpha X^*}|c|)
\end{align*}
Taking the inner product with $W_0$, this becomes
\begin{align*}
\langle W_0, C_i c \rangle &=  c_i \langle W_0, \left( R \Theta_+(X_i; 0) R - \Theta_+(X_i; 0) \right) V_0 \rangle + \mathcal{O}(|\lambda|e^{-\alpha X^*}|c| ) \\
&= c_i \left( \langle R W_0, \Theta_+(X_i; 0) R V_0 \rangle - \langle W_0, \Theta_+(X_i; 0), V_0 \rangle \right) + \mathcal{O}(|\lambda|e^{-\alpha X^*}|c| ) \\
...
where we have bound
\begin{align*}
|\tilde{A}_2(\lambda)(b, c, d) \leq C |\lambda| e^{-\alpha X^*} \left( e^{-\tilde{\alpha} X^*}  |b| + |c| +|\lambda|^2 |d| \right)
\end{align*}
\end{proof}
\end{lemma}
