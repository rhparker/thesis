...
|A_1(\lambda)(b, c, d)| \leq C \left( e^{-\tilde{\alpha} X^*} |b| + (e^{-\alpha X^*} + |C_i|)|c| + |\lambda|^2 |d| + |D_i||d| \right)
\end{align} 
...
& \leq C |\lambda|^2 |d| \int_{-X_i}^0 e^{-\tilde{\alpha}(X_i + y)} e^{\alpha y} dy \\
& \leq C |\lambda|^2 |d|
\end{align*}
...
&\leq C |c| \int_0^{-X_i} e^{-\tilde{\alpha}(X_i + y)} \left( e^{-\alpha X_i} e^{-\alpha(X_i + y) } + e^{-2 \alpha X_i} e^{\alpha y} \right) dy \\
&\leq C e^{-\alpha X^*} |c| 
\end{align*}
The other integral is similar.
\end{enumerate}
...
|L_3(\lambda)(b, c, d)| \leq C \left( e^{-\tilde{\alpha} X^*} |b| + e^{-\alpha X^*} |c| + |\lambda|^2 |d| \right)
\end{equation}
Let 
\[
...
\begin{align}
|A_2(\lambda)_i(b, c, d)|
&\leq C \left(e^{-\tilde{\alpha} X^*}|b| + e^{-\alpha X^*}|c| + |\lambda|^2|d| \right) \label{A2bound} \\
|\tilde{A}_2(\lambda)(b, c, d) &\leq C |\lambda| e^{-\alpha X_i} \left( e^{-\tilde{\alpha} X^*}  |b| + |c| +|\lambda|^2 |d| \right) \label{tildeA2bound}
\end{align}
...
where 
\begin{align*}
|A_2&(\lambda)_i(b, c, d)| \leq C \left(e^{-\tilde{\alpha} X^*}|b| + e^{-\alpha X^*}|c| + |\lambda|^2|d| \right)
\end{align*} 
...
\begin{equation*}
|P^c(\lambda)\tilde{L}_3(\lambda)_i(a,b,c,d)| \leq C |\lambda| e^{-\alpha X_i} \left( e^{-\tilde{\alpha} X^*} |b| + e^{-\alpha X^*} |c| + |\lambda|^2 |d| \right)
\end{equation*}
...
where we have bound
\begin{align*}
|\tilde{A}_2(\lambda)(b, c, d) \leq C |\lambda| e^{-\alpha X_i} \left( e^{-\tilde{\alpha} X^*}  |b| + |c| +|\lambda|^2 |d| \right)
\end{align*}
\end{proof}
\end{lemma}
...
\begin{align*}
a_i^+ &= P_0^u(\lambda) D_i d + A_4(\lambda)_i^+(c, d) \\
a_i^- &= -P_0^s(\lambda) D_i d + A_4(\lambda)_i^-(c, d) \\
...
|\tilde{A}_4(\lambda)(b, c, d)| &\leq C |\lambda| e^{-\alpha X^*} \left( |c| + (|\lambda| + e^{-\alpha X^*})^2  |d| \right) \label{tildeA4bound}
\end{align}
...
&\leq C e^{-\tilde{\alpha} X^*} \left( e^{-\tilde{\alpha} X^*} |b| + (e^{-\alpha X^*} + |C_i|)|c| + |\lambda|^2 |d| + |D_i||d| \right)
\end{align*}
...
\begin{align*}
|P^i_+(0; \lambda) \Phi^c_{i,+}(0, X_i; \lambda) P^i_+(X_i, \lambda)^{-1} a_i^c| &\leq C |\lambda| e^{-\tilde{\alpha} X_i} \left( e^{-\tilde{\alpha} X^*}  |b| + |c| +|\lambda|^2 |d| \right)
\end{align*}
...
\begin{align*}
&\left| P^i_+(0; \lambda) \int_{X_i}^0 \Phi^c_{i,+}(0, y; \lambda) P^i_+(y; \lambda)^{-1} \lambda^2 d_i \tilde{H}_i^+(y) dy \right| \leq C |\lambda|^2 |d| \int_0^{X_i} e^{-\tilde{\alpha} y} dy \leq C |\lambda|^2 |d|
\end{align*}
