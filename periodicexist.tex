...
\begin{equation}\label{Vpiecewise1}
...
We now rewrite the piecewise differential equations \eqref{Vpiecewise1} in integrated form to get the fixed point equations.
