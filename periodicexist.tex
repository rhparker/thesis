...
\begin{remark}
If $n = 1$, which repesents a periodic orbit close to the primary homoclinic orbit $Q(x)$, there is only a single jump condition which is therefore automatically safisfied. Thus $1$-periodic pulses exist for sufficiently large $X_0$.
\end{remark}
