...
For part (i), the proof of the existence of $V^c(x)$ is found in Lemma \ref{varsolutions} in \cref{sec:centersol}. Let $V^c = (\tilde{V}^c, 1)$. Then we can write $V^c(x)' = A(Q(x))V^c(x)$ as the block equation
\begin{align*}
