...
0 = \left( \tilde{h} + \mathcal{O}( r^{1/2} )\right) (\tilde{s}i + \tilde{h})X  +\frac{2 M^c \tilde{q} }{M} ( \tilde{h} + \tilde{\mu}_*(r) i)^2 r^{1/2} X_0^*(r) + \mathcal{O}(r^{1/2} + r X^3) \right)
\end{equation}
...
\begin{equation*}
\begin{aligned}
0 &= h_0 (2 \tilde{\mu}_*(r) i)(2 s_0 i + h_0) + \frac{2 M^c \tilde{q}}{M}(\tilde{\mu}_*(r) i)^3 + \mathcal{O}\left( \frac{1}{|\log r|}\right)
\end{aligned}
\end{equation*}
Finally, divide by $2 \tilde{\mu}_*(r) i$ to get the equation $G(h_0, s_0, r) = 0$, where $G: \C \times \R \times \mathcal{R} \rightarrow \C$ is defined by
\begin{equation}\label{BsimpleG0}
\begin{aligned}
G(h_0, s_0, r) &= h_0 (2 s_0 i + h_0) + \frac{M^c \tilde{q}}{M}(\tilde{\mu}_*(r) i)^2 + \mathcal{O}\left( \frac{1}{|\log r|}\right),
\end{aligned}
\end{equation}
which simplifies to
