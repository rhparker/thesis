...
\langle \Psi^c(0), V^+(0; \lambda) - V^-(0; \lambda) \rangle &= -\tilde{M}\lambda + \mathcal{O}(|\lambda|^2) \\ 
\langle \Psi(0), V^+(0; \lambda) - V^-(0; \lambda) \rangle &= -M^c \lambda + \mathcal{O}(|\lambda|^2).
\end{aligned}
\end{equation}
\begin{proof}
...
\end{align*}
The result for $\langle \Psi^c(0), V^-(0; \lambda) \rangle$ follows from the symmetry relations $\partial_\lambda \tilde{V}^-(0; 0)= -R \partial_\lambda \tilde{V}^+(0; 0)$ and $W_0 = R W_0$. The third equation in \cref{VpmIPs} follows from combining these.
...
\end{align*}
The result for $\langle \Psi(0), V^-(0; \lambda) \rangle$ follows from symmetry as above. The fourth equation in \cref{VpmIPs} follows from combining these.
\end{proof}
\end{corollary}
...
W_i^+(0) - W_i^+(0) &+ c_i( V^+(0; \lambda) - V^-(0; \lambda) ) = 0
\end{aligned}
\end{equation}
