...
From \cref{deftildeV} and \cref{Vpmlambda}, $\tilde{V}^+(x, \lambda) \rightarrow V_0(\lambda)$ as $x \rightarrow \infty$, thus $\partial_\lambda \tilde{V}^+(x, 0) \rightarrow V_0'(0)$ as $x \rightarrow \infty$. Using \cref{deftildeV} and taking the derivative with respect to $\lambda$,
\begin{align*}
\partial_\lambda V^+(x; \lambda)
...
\end{align*}
Since $v^c(y)$ and $q(y)$ are both even functions, we obtain the result in part (ii).
\end{proof}
\end{lemma}
...
\begin{aligned}
\langle \Psi^c(0), V^\pm(0; \lambda) \rangle &= 1 \mp \frac{1}{2} \tilde{M} + \mathcal{O}(|\lambda|^2) \\
