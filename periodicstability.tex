...
The terms involving $c$ will give us the leading order terms in the jump condition. Using Lemmas \ref{Vpmlambdalemma} and \ref{Ecconj}, we have
\begin{align*}
...
\begin{align*}
&\left| \langle \Psi^c(0), P_i^-(0; \lambda) \int_{-X_{i-1}}^0 \Phi^c(0, y; \lambda) P_i^-(y; \lambda) \tilde{H}_i^-(y) dy \rangle \right| \\
&\leq C \int_{-X_{i-1}}^0 e^{-|\nu(\lambda)|y}e^{\alpha y} dy \\
&\leq C \int_{-X_{i-1}}^0 e^{\tilde{\alpha} y} dy \\
&\leq C
\end{align*}
