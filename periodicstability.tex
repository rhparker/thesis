...
\]
such that for all $|\lambda| < \delta_1$, the change of coordinates $W^+ = P_+(x; \lambda) Z^+$ conjugates \eqref{Wipm2} into the equation
...
\begin{align*}
-R_{2m+1} &A(Q(-x); -\lambda) R_{2m+1}^2 
= \begin{pmatrix}-R_{2m} & 0 \\ 0 & -1 \end{pmatrix} 
\begin{pmatrix}
DF(Q(-x)) & \begin{pmatrix} 0 \\ \vdots \\ 0 \\ 1 \end{pmatrix} \\
\begin{pmatrix} -\lambda & 0 & \dots & 0 \end{pmatrix} & 0
...
In the next, we define the conjuation operator on $\R^-$.
