...
&+ \mathcal{O} \left( e^{-\alpha X_m} \left( |\lambda| +  e^{-\alpha X_m}  \right) |d| \right) \rangle \\
&= \langle \Psi^c(0), \Theta_i^s(0, -X_{i-1}; 0) P_0^s(0) ( Q'(X_{i-1}) + Q'(-X_{i-1}))(d_i - d_{i-1})\rangle \\
&+ \mathcal{O}( e^{-\alpha X_{i-1}} e^{-\alpha X_m} ( |\lambda| +  e^{-\alpha X_m} ) |d|)
\end{align*} 

Evaluating the terms $P^s_-(-X_{i-1}) P_0^s(0) Q'(X_{i-1})$ and $P^s_-(-X_{i-1}) P_0^s(0) Q'(-X_{i-1})$
\begin{align*}
...
For the term involving $Q'(X_{i-1}) + Q'(-X_{i-1})$, we have
\begin{align*}
\langle &\Psi^c(0), \Theta_i^s(0, -X_{i-1}; \lambda) P_0^s(0) ( Q'(X_{i-1}) + Q'(-X_{i-1}))(d_i - d_{i-1}) \rangle \\
&= \langle \Psi^c(0), \Theta^s(0, -X_{i-1}; 0) P_0^s(0) ( Q'(X_{i-1}) + Q'(-X_{i-1}))(d_i - d_{i-1}) \rangle + \mathcal{O}(e^{-2\alpha X_{i-1}}|\lambda||d|) \\
&= \langle \Psi^c(0), \Theta(0, -X_{i-1}; 0) P^s_-(-X_{i-1}) P_0^s(0) ( Q'(X_{i-1}) + Q'(-X_{i-1}))(d_i - d_{i-1}) \rangle + \mathcal{O}(e^{-2\alpha X_{i-1}}|\lambda||d|) \\
&= \langle \Psi^c(-X_{i-1}), P^s_-(-X_{i-1}) P_0^s(0) ( Q'(X_{i-1}) + Q'(-X_{i-1}))(d_i - d_{i-1}) \rangle + \mathcal{O}(e^{-2\alpha X_{i-1}}|\lambda||d|)
\end{align*}
