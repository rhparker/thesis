...
\end{align*}
thus $\partial_\lambda \tilde{V}^+(0; \lambda)$ solves \cref{tildeVderivsolves}. The symmetry relationship for $\partial_\lambda \tilde{V}^-(0; \lambda)$ is the same as for $\partial_\lambda V^-(0; \lambda)$
\end{proof}
\end{lemma}

** MELNIKOV NEXT **

Finally, $V^\pm(x; \lambda)$ has Taylor expansion
\begin{equation}
