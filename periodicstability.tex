...
\[
V_0'(0) = (0, -c_3/c, 0, -c_5/c, )^T
\]
which is orthogonal to $W_0$


We can similarly find an corresponding eigenvector $W(\overline{\lambda})$ with $W_0(-\overline{\lambda}) = R V_0(\overline{\lambda})$ and Taylor expansion
\[
